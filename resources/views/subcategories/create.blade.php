...
<div class="max-w-3xl mx-auto space-y-6">
    <header class="flex items-center gap-4 border-b border-slate-200 dark:border-slate-800 pb-6">
        ...
        <div>
            <h2 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">New Subcategory</h2>
            <p class="text-slate-500 dark:text-slate-400 mt-1">Refine your classification with a detailed sub-item.</p>
        </div>
    </header>

    <div class="bg-white dark:bg-card-dark rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
        <form action="{{ route('subcategories.store') }}" method="POST" class="p-8 space-y-8">
            @csrf
